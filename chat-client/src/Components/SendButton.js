...
const SendButton = (params) => {
  return (
    <div className="relative flex items-center justify-center self-center xl:w-1/2 w-3/4 p-4 overflow-hidden text-gray-600 focus-within:text-gray-400">
      <div className="w-full">
        ...
        <input
          id="message"
          className="w-full py-2 pl-10 text-sm bg-indigo-200 border border-transparent appearance-none rounded-tg placeholder-gray-800 focus:bg-white focus:outline-none focus:border-blue-500 focus:text-gray-900 focus:shadow-outline-blue"
